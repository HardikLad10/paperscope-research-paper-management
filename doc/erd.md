...
Author – Represents an academic contributor. Made separate from User because not all authors are registered users.
...
Paper–Paper: Many-to-many (papers can reference or relate to multiple other papers).
...
1 review can have comment; paper can have multiple reviews
